...
@PrepareForTest({GetContentDefinition.class,Postman.class, KafkaClient.class})
...
@Before
  ...
  public void testReadJson() throws Exception {
        ...
        PowerMockito.mock(KafkaClient.class);
        ...
        Mockito.when(Postman.GET(Mockito.anyString())).thenReturn(getEvent(getResponse));
